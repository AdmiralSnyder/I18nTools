    ...
    internal class ResourceCodeDomSerializer : CodeDomSerializer
    {
        ...
        public override object Deserialize(IDesignerSerializationManager manager, object codeObject)
        {
            ...
            if (!(codeObject is CodeStatement))
            {
                ...
                throw new ArgumentException("SerializerBadElementTypes " + codeObject.GetType().Name + " " +  str);
            }
            //}
            return obj2;
        }
        ...
        internal class SerializationResourceManager : ComponentResourceManager
        {
            ...
            private Hashtable CreateResourceSet(IResourceReader reader, CultureInfo culture)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        exception2 = new SerializationException("SerializerResourceExceptionInvariant " + message, exception);
                    }
                    else
                    {
                        exception2 = new SerializationException("SerializerResourceException" +  message, exception);
                    }
